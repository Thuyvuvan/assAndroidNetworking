...
import com.example.myapplication.model.gallery.Example;
import com.example.myapplication.model.gallery.Gallery;
                ...
                gralleryViewAdapter = new GralleryViewAdapter(getApplication(), (ArrayList<Gallery>) galleries,
                        new GralleryViewAdapter.AdapterListenerGallery() {
                            ...
                            public void OnClick(int position) {
                                Intent intent = new Intent(Gallery_Activity.this, com.example.myapplication.Gallery_ChiTiet.class);
